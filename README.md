...
dependencies {
     // NeoForge
     implementation group: 'net.darkhax.maxhealthfix', name: 'maxhealthfix-neoforge-26.1.2', version: '26.1.2.0'
     // Fabric
     implementation group: 'net.darkhax.maxhealthfix', name: 'maxhealthfix-fabric-26.1.2', version: '26.1.2.0'
     // Common / MultiLoader / Vanilla / No Loader
     implementation group: 'net.darkhax.maxhealthfix', name: 'maxhealthfix-common-26.1.2', version: '26.1.2.0'
}
```
